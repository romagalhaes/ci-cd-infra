...
- O state deste repositorio usa a chave `environments/dev/resources/service/ci-cd/terraform.tfstate`
...
- Cloud provider: `aws`
- Region: `us-east-1`
- Repositorio da aplicacao: https://github.com/romagalhaes/ci-cd
